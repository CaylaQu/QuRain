...
void Tile::DrawNavigation()
{
	...
	if (m_node != nullptr) // do not draw connections on a null PathNode 
	{
...
{
	m_cost = cost; // will be formatted to one decimal place 
...
void Tile::AddNode()
{
	m_node = new PathNode(this); // "this" is a pointer to this Tile. 
}
